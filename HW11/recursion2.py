...
def groupSumClump(start, nums, target):
    if start >= len(nums):
        ...
        return groupSumClump(start + 2, nums, target - 2 * nums[start])
...
https: // github.com / ozelentok / CodingBat - Solutions / blob / master / Java / Recursion - 2.j


https: // github.com / Betanya / CS303E - / blob / master / recursion3.py
